/**
 * Role: 운영/관리자 목록 페이지 — 직원 조회, 승인/거절, 상세 이동
...
const mockData: AdminUser[] = [
  { id: '10', no: 10, name: '이민혁', userId: 'kris', phone: '010-1111-1111', affiliation: '본사', position: '최고관리자', joinDate: '2026.01.01', approvalStatus: 'approved', approvalDate: '2026.02.01', activityStatus: '정상' },
  { id: '9', no: 9, name: '이민혁', userId: 'kris', phone: '010-1111-1111', affiliation: '본사 > 사업단 1 > 지점 1 > 팀 1', position: '팀장', joinDate: '2026.01.01', approvalStatus: 'pending', activityStatus: '대기' },
  { id: '8', no: 8, name: '이민혁', userId: 'kris', phone: '010-1111-1111', affiliation: '본사 > 사업단 1 > 지점 1', position: '지점장', joinDate: '2026.01.01', approvalStatus: 'pending', activityStatus: '대기' },
  { id: '7', no: 7, name: '이민혁', userId: 'kris', phone: '010-1111-1111', affiliation: '본사 > 사업단 1 > 지점 1 > 팀 1', position: '팀장', joinDate: '2026.01.01', approvalStatus: 'approved', approvalDate: '2026.02.01', activityStatus: '일시제한' },
  { id: '6', no: 6, name: '이민혁', userId: 'kris', phone: '010-1111-1111', affiliation: '본사 > 사업단 1', position: '사업단장', joinDate: '2026.01.01', approvalStatus: 'approved', approvalDate: '2026.02.01', activityStatus: '일시제한' },
  { id: '5', no: 5, name: '이민혁', userId: 'kris', phone: '010-1111-1111', affiliation: '본사', position: '최고관리자', joinDate: '2026.01.01', approvalStatus: 'pending', activityStatus: '대기' },
  { id: '4', no: 4, name: '이민혁', userId: 'kris', phone: '010-1111-1111', affiliation: '본사 > 사업단 1 > 지점 1 > 팀 1', position: '팀장', joinDate: '2026.01.01', approvalStatus: 'pending', activityStatus: '대기' },
  { id: '3', no: 3, name: '이민혁', userId: 'kris', phone: '010-1111-1111', affiliation: '본사 > 사업단 1 > 지점 1 > 팀 1', position: '팀장', joinDate: '2026.01.01', approvalStatus: 'pending', activityStatus: '대기' },
  { id: '2', no: 2, name: '이민혁', userId: 'kris', phone: '010-1111-1111', affiliation: '본사 > 사업단 1 > 지점 1 > 팀 1', position: '팀장', joinDate: '2026.01.01', approvalStatus: 'pending', activityStatus: '대기' },
  { id: '1', no: 1, name: '이민혁', userId: 'kris', phone: '010-1111-1111', affiliation: '본사', position: '최고관리자', joinDate: '2026.01.01', approvalStatus: 'pending', activityStatus: '대기' },
];
